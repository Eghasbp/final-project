...
const Register = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className="container m-auto h-screeen w-screen items-center bg-white rounded-md shadow-lg "
          style={{
        ...
        >
          <div className="lg:grid grid-cols-2 gap-5 items-center py-4">
              ...
              <div className="flex justify-center">
                <div className="mt-4 w-80 relative">
                  ...
                  <TextInput
                    ...
                    required
                    rightIcon={visiblePassword ? HiEye : HiEyeOff}
                    type={visiblePassword ? "text" : "password"}
                  />
                  <span
                    className="absolute right-0 top-2 w-10 h-10"
                    onClick={() =>
                      setVisiblePassword((prev) => (prev ? false : true))
                    }
                  ></span>
                </div>
              </div>
