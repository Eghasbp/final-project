...
import bg from '../assets/bg.png'
  ...
  return (
    <div className='w-full border border-gray-300 rounded-xl bg-gradient-to-r from-gray-300  to-gray-300 h-full' style={{  background: `url(${bg})`,
    backgroundSize: 'contain',
    backgroundPosition: 'center',
    backgroundBlendMode: 'multiply',
    }}>
      <h2 className='text-center p-4 font-bold font-inter text-2xl text-white bg-gray-600 rounded-lg'>Banner Showcase</h2>
    <div className=' h-[500px] w-1/2 m-auto py-8 px-4 relative group'>
    <div className='w-full h-full rounded-2xl bg-center bg-cover duration-500'>
      <img className='h-[380px] w-full rounded-lg shadow-2xl' src={pictures[currentIndex]?.imageUrl} alt="" />
    </div>
      {/* Left Arrow */}
