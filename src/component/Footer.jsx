                ...
                <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                  <div className="lg:col-span-4 md:col-span-12">
                    ...
                    <p className="mt-6 text-gray-300">
                      I am currently engaged in a fascinating React project in
                      partnership with dibimbing.id, where our primary objective
                      is to construct an exceptional travel website. This
                      project involves the utilization of various web
                      development technologies and tools to craft a
                      user-friendly and visually appealing platform for
                      travelers.
                    </p>
