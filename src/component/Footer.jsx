                            ...
                            <div className="lg:col-span-4 md:col-span-12">
                                <a href="#" className="text-[22px] focus:outline-none">
                                    <img className="h-12"
                                        src={Logo}
                                        alt="" />
                                        <p className='text-white font-medium'>Travelasia</p>
                                </a>
                                <p className="mt-6 text-gray-300">
                                I am currently engaged in a fascinating React project in partnership with dibimbing.id, where our primary objective is to construct an exceptional travel website. This project involves the utilization of various web development technologies and tools to craft a user-friendly and visually appealing platform for travelers.
                                </p>
                                <ul className="list-none mt-6">
                                    <li className="inline">
                                        <a href=""
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 fill-gray-300"
                                                viewBox="0 0 24 24">
                                                <path
                                ...
                                <form>
                                    <div className="grid grid-cols-1">
                                        ...
                                        <button type="submit" id="submitsubscribe" name="send"
                                            className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-[#4951ea] border-[#588ff4] text-white rounded-md">
                                            Subscribe
                                        </button>
                                    </div>
                                </form>
                ...
                <div className="grid md:grid-cols-2 items-center">
                    <div className="md:text-left text-center">
                        <p className="mb-0">
                            ...
                            TailwindSnippets Team & dibimbing.id
                        </p>
                    </div>
                </div>
